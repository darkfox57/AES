...
export default function ShowForm({ formToShow, updateForm }) {
  return (
    <>
      {formToShow === 'Form_Especialistas' && (
        <Form_Especialistas isOpen={true} setMainForm={updateForm} />
      )}
      {formToShow === 'Form_Instituciones' && (
        <Form_Instituciones isOpen={true} setMainForm={updateForm} />
      )}
      {formToShow === 'Form_Alianzas' && (
        <Form_Alianzas isOpen={true} setMainForm={updateForm} />
      )}
    </>
  )
}
